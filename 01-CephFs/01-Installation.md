...
#### Set below DNS for limited connections:😔
# DNS1: 185.55.225.25 
# DNS2: 185.55.226.26
----
...
systemctl enable chrony && systemctl restart chronyd
...
ceph orch host add ceph02 172.16.100.3 mon
ceph orch host add ceph03 172.16.100.4 mon
